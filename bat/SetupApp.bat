...
:: Android packaging
set AND_CERT_NAME="StarlingBuilder2"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StarlingBuilder2.p12
...
set IOS_PROVISION=cert\StarlingBuilder2.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=StarlingBuilder2
